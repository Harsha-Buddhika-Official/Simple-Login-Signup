    ...
    <div className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen px-2 sm:px-0">
      <div className="flex justify-center items-center min-h-screen">
        <div className="w-full max-w-xs sm:max-w-md p-4 sm:p-6 bg-white dark:bg-gray-800 rounded shadow">
          ...
          {error && (
            <div className="mb-2 sm:mb-4 text-red-600 text-center font-medium text-sm sm:text-base">
              {error}
            </div>
          )}
            ...
            <div className="flex flex-col">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="border rounded px-3 py-2 pr-10 w-full bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                />
                <button
                  type="button"
